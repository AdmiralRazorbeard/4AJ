	...
	<div class="mainWrapper">
		...
		<nav id="menu">
			<ul>
				...
				<li><a <?php if (openSection('gestionRepas') || openSection('verrouillerRepas') || openSection('menuSemaine') || openSection('horaireLimite')){?>id="active_menu_item"<?php } else { ?>class="menu_item"<?php } ?> href="index.php?section=gestionRepas">Repas</a></li>
