	...
	<div class="mainWrapper">
		...
		<nav id="menu">
			<ul>
				...
				<li><a <?php if (openSection('item4')){?>id="active_menu_item"<?php } else { ?>id="menu_item"<?php } ?> href="index.php?section=livreOrAConfirmer"><?php if(nouveauLivreOrAConfirmer()){ echo 'Yolo'; } ?>Livre d'or à confirmer</a></li>
