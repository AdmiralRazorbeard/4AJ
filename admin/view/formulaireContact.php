			...
			<div class="contentWrapper fonction">
				...
				<fieldset id="formulaireContact">
					...
					<form method="post">
						...
						<input type="text" name="mailAnneFrank" id="mailPlateformeLogement" value="<?php echo $mailFormulaire['mailAnneFrank']; ?>"><input type="submit">
						</p>
					</form>
					<form method="post">
						<p class="form-field">
						<label for="mailClairLogis">Pour Clair Logis : </label>
						<input type="text" name="mailClairLogis" id="mailClairLogis" value="<?php echo $mailFormulaire['mailClairLogis']; ?>"><input type="submit">
						</p>
					</form>
					<form method="post">
						<p class="form-field">
						<label for="mailNobel">Pour Nobel : </label>
						<input type="text" name="mailNobel" id="mailNobel" value="<?php echo $mailFormulaire['mailNobel']; ?>"><input type="submit">
						</p>
					</form>
				</fieldset>
			</div>
