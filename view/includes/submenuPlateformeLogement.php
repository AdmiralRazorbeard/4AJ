<nav id="subMenu">
	<ul>
		...
		<li><a <?php if (openSubSection('atelier')){?>class="active_submenu_item"<?php } else { ?>class="submenu_item"<?php } ?> href="index.php?section=plateformeLogement&amp;subSection=atelier"><?php langue('Atelier', 'Workshop'); ?></a></li>
		...
		<li><a <?php if (openSubSection('contact')){?>class="active_submenu_item correct_size_contactPlateforme"<?php } else { ?>class="submenu_item correct_size_contactPlateforme"<?php } ?> href="index.php?section=plateformeLogement&amp;subSection=contact">Contact</a></li>	
	</ul>
</nav>