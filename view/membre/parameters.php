			...
			<div class="contentWrapper parameters">
				...
				<form method="post">
					<fieldset>
						...
						<p>
							<label for="recevoirMailQuandNews">Autoriser la réception de newsletters : </label><input type="checkbox"  id="recevoirMailQuandNews" <?php if($infoMembre['recevoirMailQuandNews']) { echo 'checked'; } ?> name="recevoirMailQuandNews"> 
						</p>
						<input type="submit">
					</fieldset>
				</form>
